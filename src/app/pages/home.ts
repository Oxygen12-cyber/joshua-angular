    ...
    <div class="min-h-[80vh] flex items-center justify-center py-16 px-6 bg-white text-gray-900 font-sans">
      <div class="max-w-3xl flex flex-col items-start gap-6">
        ...
        <h1 class="text-5xl md:text-7xl font-bold tracking-tight text-gray-900 leading-tight">
          Hi, I'm Joshua. <br/>
          <span class="text-gray-400">Software Developer <span class="text-6xl text-orange-200">.</span></span>
        </h1>
        ...
        <div class="flex gap-4 mt-8">
          <a routerLink="/projects" class="px-4 py-4 bg-gray-900 text-white font-medium hover:bg-gray-800 transition-colors">
            View My Work
          </a>
          <a routerLink="/contact" class="px-4 py-4 border border-gray-300 font-medium hover:bg-gray-50 transition-colors text-gray-900">
            Get in Touch
          </a>
        </div>
      </div>
